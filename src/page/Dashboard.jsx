            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
              {quickAccessOptions.map((option, index) => (
                <button
                  ...
                  className={`group relative flex flex-col items-center overflow-hidden rounded-2xl bg-white p-4 text-center shadow-md transition-all hover:-translate-y-1 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#45923a]/50 ${index === 0 ? 'col-span-2 sm:col-span-1' : ''
                    }`}
