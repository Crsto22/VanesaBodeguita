...
const DeleteDrawer = ({ isOpen, onClose, onConfirm, proveedorName, colors, loading }) => {
    return (
        <>
            {isOpen && (
                <div
            ...
            >
                <div className="flex flex-col h-full p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                        ¿Estás seguro de eliminar a <span className="font-medium">{proveedorName}</span>? Esta acción no se puede deshacer.
                    </p>
