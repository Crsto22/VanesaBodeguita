...
const DeleteDrawerCategoria = ({ isOpen, onClose, onConfirm, categoryName, productosAsociados, colors, loading }) => {
  return (
    <>
      {isOpen && (
          ...
          <div className="flex-1">
            ...
            {productosAsociados === null ? (
              ...
              <div className="bg-amber-50 text-amber-800 px-3 py-2 rounded-lg text-sm">
                <p>
                  <strong>Advertencia:</strong> Esta categoría tiene {productosAsociados}{' '}
                  {productosAsociados === 1 ? 'producto' : 'productos'} asociados. Al eliminarla, estos productos quedarán sin categoría.
                </p>
              </div>
            ) : null}
          </div>
...
export default DeleteDrawerCategoria;